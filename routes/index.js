...
router.get('/', function (req, res) {
  res.render('index', { title: 'LunchBox App', user: req.user });
});
router.get('/register', function (req, res) {
  res.render('register', { title: 'LunchBox App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'LunchBox App Login', user: req.user });
});
